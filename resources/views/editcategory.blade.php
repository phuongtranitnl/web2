...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="{!! URL::Route('update.category',$id) !!}" method="Post">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" value="{{ old('NameCategory',$getCategoryById['NameCategory']) }}" name="name" placeholder="Enter your name">
